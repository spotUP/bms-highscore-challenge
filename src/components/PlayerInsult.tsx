...
const PLAYER_MESSAGES = {
  ronny: [
    ...
    "Ronny, that score is so low, it's practically underground! ",
    ...
    "Ronny, your gaming skills are like a broken pencil - pointless! ",
  ...
  lars: [
    "Lars, that score is so terrible, it should be in a museum! ",
    ...
    "Nice try Lars! Your score is so low, it's digging its own grave! ",
    ...
    "Nice one Lars! Your score is so low, it's in the sub-basement! ",
  ...
  default: [
    ...
    "Magnificent! You are the gaming equivalent of a superhero! ",
    ...
    "Your gaming prowess is so legendary, it should be in a museum! ",
    ...
    "Incredible! You are the gaming equivalent of a wizard! ",
