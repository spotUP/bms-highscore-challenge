-- Fix the achievement system using the existing table structure
-- Run this in your Supabase SQL Editor

-- 1. First, let's see what the 'type' enum values are
SELECT unnest(enum_range(NULL::achievement_type)) as type_values;

-- 2. Update existing achievements with proper type and criteria
...
-- 3. Add more achievements using the existing structure
INSERT INTO achievements (name, description, type, badge_icon, badge_color, criteria, points) VALUES
-- Score-based achievements
('Century Club', 'Score 100 points or more', 'score_based', '💯', '#ff6b6b', '{"condition": "score_threshold", "value": 100}', 25),
('Half Grand', 'Score 500 points or more', 'score_based', '🔥', '#ffa500', '{"condition": "score_threshold", "value": 500}', 50),
('Grand Master', 'Score 1000 points or more', 'score_based', '👑', '#ffd700', '{"condition": "score_threshold", "value": 1000}', 100),
('High Roller', 'Score 5000 points or more', 'score_based', '🎰', '#9b59b6', '{"condition": "score_threshold", "value": 5000}', 200),

-- First place achievements
('First Victory', 'Win your first game', 'score_based', '🏆', '#f39c12', '{"condition": "first_place", "value": 1}', 50),
('Champion', 'Win 5 games', 'score_based', '🥇', '#e67e22', '{"condition": "first_place", "value": 5}', 150),
('Dominator', 'Win 10 games', 'score_based', '👑', '#d35400', '{"condition": "first_place", "value": 10}', 300),

-- Total scores achievements
('Getting Started', 'Submit 5 scores', 'score_based', '📝', '#3498db', '{"condition": "total_scores", "value": 5}', 25),
('Regular Player', 'Submit 25 scores', 'score_based', '🎮', '#2980b9', '{"condition": "total_scores", "value": 25}', 75),
('Dedicated Gamer', 'Submit 50 scores', 'score_based', '🎯', '#1abc9c', '{"condition": "total_scores", "value": 50}', 150),
('Score Master', 'Submit 100 scores', 'score_based', '🏅', '#16a085', '{"condition": "total_scores", "value": 100}', 300),

-- Streak achievements
('Hot Streak', 'Get a 3-game streak', 'score_based', '🔥', '#e74c3c', '{"condition": "streak", "value": 3}', 50),
('On Fire', 'Get a 5-game streak', 'score_based', '⚡', '#c0392b', '{"condition": "streak", "value": 5}', 100),
('Unstoppable', 'Get a 10-game streak', 'score_based', '💥', '#8e44ad', '{"condition": "streak", "value": 10}', 250),

-- Game-based achievements
('Explorer', 'Play 3 different games', 'game_based', '🗺️', '#27ae60', '{"condition": "unique_games", "value": 3}', 50),
('Adventurer', 'Play 5 different games', 'game_based', '🏔️', '#2ecc71', '{"condition": "unique_games", "value": 5}', 100),
('Game Master', 'Play 10 different games', 'game_based', '🎲', '#1abc9c', '{"condition": "unique_games", "value": 10}', 200),
('Arcade Legend', 'Play 20 different games', 'game_based', '🎪', '#16a085', '{"condition": "unique_games", "value": 20}', 500);
