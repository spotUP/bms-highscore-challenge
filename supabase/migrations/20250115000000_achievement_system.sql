...
CREATE INDEX idx_player_achievements_player ON player_achievements(player_name);
...
-- RLS Policies - Allow everyone to read achievements
...
-- System can insert player achievements (via functions)
