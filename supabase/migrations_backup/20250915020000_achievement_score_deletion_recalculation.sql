-- Achievement Recalculation for Score Deletion
-- This migration adds functionality to recalculate and remove invalid achievements
-- when scores are deleted from the system.
